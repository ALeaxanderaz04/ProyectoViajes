    ...
    const IngresarSucursal = (e) => {
        ...
        if (!Sucursal.trim() || !Deparatemento || !Municipio || !Direccion.trim()) {
            ...
            let payload = {
                ...
                sucu_UsuCreacion: parseInt(localStorage.getItem('usuID'))
            }
            axios.post(Global.url + 'Sucursal/Insertar', payload)
                .then((r) => {
                    if (r.data.data.messageStatus != null) {
                        ...
                        setSucursalId(parseInt(r.data.data.messageStatus));
                ...
                <div className='col-7'>
                    <div className='card'>
                        <div className="grid p-fluid">
                            ...
                            <div className='col-6'>
                                <div className="field">
                                    <Button label="Guardar" disabled={Form1Activado} icon="pi pi-check" severity="success" onClick={IngresarSucursal} />
                                </div>
                            </div>
