    ...
    const Insetar = (e) => {
        ...
        if (!Nombres.trim()     || !Apellidos.trim()    || !Identidad.trim() || !FechaNac || !Sexo ||
            ...
            let Transportista = {
                ...
                tran_PagoKm : PagoKm,
                tran_UsuCreacion: parseInt(localStorage.getItem('usuID'))
            }

            axios.post(Global.url + 'Transportista/Insertar', Transportista)
                .then((r) => {

                    if (r.data.data.messageStatus == '1') {
                        localStorage.setItem('Transportista', '1');
                ...
                <div className="grid p-fluid">
                    ...
                    <div className='col-6'>
                        <div className="field">
                            ...
                            />
                            {submitted && !PagoKm.trim() && <small className="p-invalid" style={{ color: 'red' }}>El campo es requerido.</small>}
                        </div>
                    </div>
