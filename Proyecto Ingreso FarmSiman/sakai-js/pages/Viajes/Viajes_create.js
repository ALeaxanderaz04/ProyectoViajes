    ...
    const IngresarViajes = (e) => {
        ...
        if (!Sucursal || !FechaViaje || !Transportista) {
            ...
            let payload = {
                ...
                viaj_UsuCreacion: parseInt(localStorage.getItem('usuID'))
            }
            axios.post(Global.url + 'Viajes/Insertar', payload)
                .then((r) => {
                    if (r.data.data.messageStatus != null) {
                        ColaboradoresDDl(r.data.data.messageStatus)
                        setViajeId(r.data.data.messageStatus)
                ...
                <div className='col-6'>
                    <div className='card'>
                        <div className="grid p-fluid">
                            ...
                            <div className='col-6'>
                                <div className="field">
                                    <Button label="Guardar" disabled={Form1Activado} icon="pi pi-check" severity="success" onClick={IngresarViajes} />
                                </div>
                            </div>
